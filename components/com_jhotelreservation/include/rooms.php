...
foreach( $this->rooms as $room )
{
	...
	<tr>
		...
		<td colspan=1 align="center" style="padding-left:15px;" >
			<?php
			$is_checked = false;
			...
			?>
					...
					<button 
						...
						><?php echo JText::_('LNG_BOOK',true)?>
					</button>
			</span>
			<?php }else{ 
		...
		<td class="td_cnt" colspan="9" >
			<div class="cnt">
				<div class="room-description">
					...
					<div id="calendar-holder-<?php echo $room->room_id?>" class="room-calendar" style="<?php echo $hideCalendars?"display:none":"";?>">	
